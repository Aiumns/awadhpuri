<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FairSheet_Uploading.aspx.cs" Inherits="Cargo_FairSheet_Uploading" %>
    ...
    <center>
        <table class="boldtext">
            <caption>
                ...
                <tr>
                    <td  align="center" 
                        style="font-size: large; font-weight: bold; font-style: normal; font-variant: normal; text-transform: none; color: #808080">
                        Add Stock </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:FileUpload ID="FileUpload1" runat="server" />&nbsp;                        
                        <asp:Button ID="btnupload" runat="server" onclick="btnSample_Click" 
                            Text="Add Stock"  OnClientClick="return Validate();" />                       
